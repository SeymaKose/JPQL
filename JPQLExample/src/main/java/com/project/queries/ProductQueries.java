...
public class ProductQueries {
	...
	public static final String findProductId = "SELECT p FROM Product p WHERE p.productId = :productId";
	
	public static final String findProductDetails = "SELECT new com.project.model.ProductDetails(p.name, p.unitPrice, p.available, b.name, c.name) "+
	                                                 "FROM Product p LEFT JOIN p.brand b LEFT JOIN p.category c WHERE p.productId = :productId";
	
	public static final String findProductDetailsById = "SELECT p.name FROM Product p";
	
	public static final String findProductNames = "SELECT p.name, p.unitPrice FROM Product p";
	
	public static final String findProductNamePrice = "SELECT p.name, p.unitPrice FROM Product p";
	
	public static final String findSpecificPrice = "SELECT p FROM Product p WHERE p.unitPrice > :unitPrice";
	
	public static final String findLessMorePrice = "SELECT p FROM Product p WHERE p.unitPrice > :minUnitPrice AND p.unitPrice < :maxUnitPrice";
	...
	public static final String findGroupByHavingCategory = "SELECT p.category.name, AVG(p.unitPrice) FROM Product p GROUP BY p.categoryName HAVING AVG(p.unitPrice) > :unitPrice" ;
